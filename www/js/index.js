...
function get_background(){
    ...
    var query = "2";
    $.post('http://autoplay.es/racing_calendar/m/test2.php',{ buscar: query }, function(data) { alert();
...
$(document).on('deviceready', function() {
    ...
    $loginButton.on('click', function() { 
        googleapi.authorize({
            ...
            //ocultar boton
            $("#login").hide();
            $.post('http://autoplay.es/racing_calendar/m/get_data.php', { parametro: toka_toka}, function(data23) {
                alert(data23);
            });
